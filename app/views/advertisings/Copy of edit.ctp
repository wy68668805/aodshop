...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Advertising.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Advertising.id'))); ?></li>
		<li><?php echo $this->Html->link(__('List Advertisings', true), array('action' => 'index'));?></li>
