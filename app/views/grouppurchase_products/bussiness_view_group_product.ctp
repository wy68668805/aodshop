...
<h2><?php  __('Grouppurchase Product');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php
				echo $this -> Html -> image('../upload/' . $grouppurchaseProduct['GrouppurchaseProduct']['picture'], array('title' => 'group_product_img', 'width' => '100%'));
			?>
			&nbsp;
		</dd>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php if($grouppurchaseProduct['GrouppurchaseProduct']['is_pass'] == 1){
				echo __('Yes',true);
			}else{
				echo __('No',true);
			}; ?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php if($grouppurchaseProduct['GrouppurchaseProduct']['is_onsale'] == 1){
				echo __('Yes',true);
			}else{
				echo __('No',true);
			}; ?>
