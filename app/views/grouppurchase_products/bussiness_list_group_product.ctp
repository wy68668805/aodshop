<div class="grouppurchaseProducts index">
	...
	<div class="actions">
		<ul>
			<li><?php echo $this->Html->link(__('New Group Product', true), array('controller' => 'grouppurchase_products', 'action' => 'bussinessAddGroupProduct'));?> </li>
		</ul>
	</div>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php if($grouppurchaseProduct['GrouppurchaseProduct']['is_pass'] == 1){
			echo __('Yes',true);
		}else{
			echo __('No',true);
		}; ?>&nbsp;</td>
		...
		<td><?php if($grouppurchaseProduct['GrouppurchaseProduct']['is_onsale'] == 1){
			echo __('Yes',true);
		}else{
			echo __('No',true);
		}; ?>&nbsp;</td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'bussinessViewGroupProduct', $grouppurchaseProduct['GrouppurchaseProduct']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'bussinessEditGroupProduct', $grouppurchaseProduct['GrouppurchaseProduct']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'bussinessDeleteGroupProduct', $grouppurchaseProduct['GrouppurchaseProduct']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $grouppurchaseProduct['GrouppurchaseProduct']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
