<div class="productComments index">
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($productComment['User']['id'], array('controller' => 'users', 'action' => 'view', $productComment['User']['id'])); ?>
		</td>
		<td>
		...
		<td><?php echo $productComment['ProductComment']['time']; ?>&nbsp;</td>
		<td><?php echo $productComment['ProductComment']['created']; ?>&nbsp;</td>
		<td><?php echo $productComment['ProductComment']['modified']; ?>&nbsp;</td>
		<td class="actions">
