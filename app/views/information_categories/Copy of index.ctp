<div class="informationCategories index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $informationCategory['InformationCategory']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $informationCategory['InformationCategory']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $informationCategory['InformationCategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
